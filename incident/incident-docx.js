...
window.AQIncidentDoc = (function () {
  ...
  function buildBody(inc, blank) {
    ...
    x += table(
      ...
      "</w:tr>" +
      // Always blank, never populated from the record: identifiers are completed in pen
      // on the printed copy so they never enter the platform's database.
      "<w:tr>" +
        labelCell("Name of individual involved", "", 3120) +
        labelCell("Age", "", 3120) +
        labelCell("Gender / UHID", "", 3120) +
      "</w:tr>", { width: 9360 });
    ...
    x += spacer(140);
    x += para(run(
      "Complete the identity fields in section 1 by hand; they are intentionally left blank " +
      "and are not stored in AQcredix. Generated by AQcredix. Adapt the wording to your organisation\u2019s incident policy " +
